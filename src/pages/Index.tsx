        ...
        <div className="relative z-10 container h-full flex items-center justify-start px-4 md:px-8">
          <div className="max-w-3xl space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              ...
              <Button variant="outline" onClick={() => navigate('/vendor')} className="border-2 border-white/60 hover:border-white px-8 py-6 text-lg font-semibold backdrop-blur-sm transition-all duration-200 text-green-500 bg-slate-50">
                Join as Vendor
              </Button>
            </div>
